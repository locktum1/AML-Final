                ...
                <div class="flex flex-col w-full">
                    ...
                    <table class="border border-black-300">
                        ...
                        <tbody>
                            @foreach ($logs as $log)
                            <tr>
                                <td class="border border-black-300">{{ $log->user->name ?? 'Guest' }}</td>
                                <td class="border border-black-300">{{ $log->action }}</td>
                                <td class="border border-black-300">{{ $log->details }}</td>
                                <td class="border border-black-300">{{ $log->ip }}</td>
                                <td class="border border-black-300">{{ $log->created_at }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
