<div {{ $attributes->merge(['class' => "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-500 w-[60vw] h-[70vh] rounded-[15px]"]) }}>
    ...
    <div class="flex flex-col items-center">
        <form action="/create-subscription" method="POST" id="subscription-form">
            ...
            <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="{{ env('STRIPE_KEY') }}" data-amount="500" data-name="AML" data-description="Basic subscription" data-locale="auto" data-currency="usd"></script>
        </form>
    </div>
</div>
