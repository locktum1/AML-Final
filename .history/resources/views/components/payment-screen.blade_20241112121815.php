    <div {{ $attributes->merge(['class' => 'absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-500 w-[60vw] h-[70vh] rounded-[15px]']) }}>
        ...
        <div class="flex mx-auto overflow-x-auto w-[90%] space-x-4 items-center justify-center">
            <x-payment-type src="{{ asset('assets/visa.jpg') }}" alt="visa logo"></x-payment-type>
            <x-payment-type src="{{ asset('assets/paypal.jpg') }}" alt="paypal logo"></x-payment-type>
            <x-payment-type src="{{ asset('assets/google-pay.jpg') }}" alt="google pay logo"></x-payment-type>
        </div>
        <div class="w-full h-full flex items-center flex-col bg-gray-700">
            <x-text-input for='Visa' type='text' label='Card number'></x-text-input>
        </div>
    </div>
