        ...
        <div id="payment-selection-div">
            <div id="payment-info" class="bg-gray-600 w-full rounded-[15px]"></div>
                ...
                <div class="flex mx-auto overflow-x-auto w-[90%] space-x-4 items-center justify-center">
                    ...
                    <x-payment-type src="{{ asset('assets/paypal.jpg') }}" alt="paypal logo" type='paypal' onclick=""></x-payment-type>
                    <x-payment-type src="{{ asset('assets/google-pay.jpg') }}" alt="google pay logo" type='gpay' onclick=""></x-payment-type>
                </div>
            </div>
    </div>
