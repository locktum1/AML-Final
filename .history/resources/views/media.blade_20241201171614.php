            ...
            <div>
                <div class="flex overflow-x-auto w-full space-x-4 justify-center">
                    ...
                    <div id="mediaInfo">
                        ...
                        @if ($borrowedBefore)
                        <button onclick="ShowReviewWindow" class="bg-blue-200 w-[10rem] h-[2rem] rounded-[5px] shadow-sm mt-[10px] active:bg-blue-500 text-black"></button>
                        @endif
                    </div>
                    <div id="reviewWindow" class="hidden">
                        <x-review-window></x-review-window>
                    </div>
                </div>
            </div>
        </main>
