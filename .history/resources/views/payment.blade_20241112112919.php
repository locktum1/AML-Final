<x-base>
    <x-slot:content>
        <main class="flex justify-center items-center h-screen">
            <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-500 w-[60vw] h-[70vh] flex justify-center">
                <h1>Select your payment method</h1>
                <div class="flex overflow-x-auto w-[90%] space-x-4 items-center justify-center">
