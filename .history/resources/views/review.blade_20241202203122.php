                ...
                <div class="flex flex-col w-full">
                    ...
                    <ul>
                        ...
                        <li class="flex items-center justify-between mb-4 max-w-full">
                            <h2 class="text-[1.2rem] break-words max-w-[100%]">Media: {{ $review->media->title }} - Posted by: user_id_{{ $review->user_id }} - Rating: {{ $review->rating }} - Review: {{ $review->review }} - {{ $review->published_on }}</h2>
                        </li>
                        @empty
                        <li>
