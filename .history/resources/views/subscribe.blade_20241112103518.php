        ...
        <main x-data="{ showPaymentScreen: false }" class="flex justify-center items-center h-screen">
            <div class="absolute top-[5vh] bg-gray-500 w-[70vw] h-[80vh] mt-[5vh] rounded-[30px] flex items-center flex-col">
                ...
                <div class="flex overflow-x-auto w-full space-x-4 justify-center">
                    <x-subscription-tier tier='Basic' price='£5' benefits='Borrow one media product at a time with a 1 month return window.' @click="showPaymentScreen "></x-subscription-tier>
