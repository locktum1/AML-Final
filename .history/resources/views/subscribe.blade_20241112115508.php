<x-base>
    <x-slot:content>
        <main class="flex justify-center items-center h-screen">
            <div id="subscription-screen" class="absolute top-[5vh] bg-gray-500 w-[70vw] h-[80vh] mt-[5vh] rounded-[30px] flex items-center flex-col">
...
<script>
    function ShowPaymentScreen(){
        ...
        var paymentScreen = document.getElementById("subscription-screen");
