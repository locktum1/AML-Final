<x-base>
    <x-slot:content>
        <main class="flex justify-center items-center h-screen">
            ...
            <x-payment-info-gpay id="payment-details-gpay" class="hidden"></x-payment-info-gpay>
            <x-payment-info-paypal id="payment-details-paypal" class="hidden"></x-payment-info-gpay>
            <x-payment-info-visa id="payment-details-visa" class="hidden"></x-payment-info-gpay>
        </main>
    </x-slot>
</x-base>
...
<script>
    ...
    function DisplayVisaPaymentInfo(){
        var paymentInfo = document.getElementById("payment-details-visa");
        paymentInfo.classList.remove("hidden");
    }

    function DisplayPaypalPaymentInfo(){
        var paymentInfo = document.getElementById("payment-details-paypal");
        paymentInfo.classList.remove("hidden");
    }

    function DisplayGPayPaymentInfo(){
        var paymentInfo = document.getElementById("payment-details-gpay");
        paymentInfo.classList.remove("hidden");
    }
</script>
