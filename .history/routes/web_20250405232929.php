...
Route::middleware(['guest'])->group(function(){
    Route::get('/2fa-verify',[TwoFactorAuthController::class, 'ShowVerify2FAView'])->name('2fa.view');
    Route::POST('/2fa-verify', [TwoFactorAuthController::class, 'ShowVerify2FAView'])->name('2fa.view');
});
